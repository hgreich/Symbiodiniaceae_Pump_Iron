---
title: "fig_7_allalgae_growthcomparison"
author: "Hannah Reich"
date: "July 2, 2019"
...
fig <- ggplot(x, aes(x = x$Fe_prime_nM, y = x$SPGROWTH, color = x$algal_lin))+
  ...
  scale_color_manual(values = cols, name = "Algal lineage", breaks = c("Symbiodiniaceae", "coastal dino", "coastal diatom", "oceanic diatom", "oceanic cocco"),  labels =c("Symbiodiniaceae", "Coastal Dinoflagellates", "Coastal Diatoms", "Oceanic Diatoms", "Oceanic Coccolithophores")) +
